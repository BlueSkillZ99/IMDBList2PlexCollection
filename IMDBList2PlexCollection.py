#------------------------------------------------------------------------------
#
#     Automated CSV IMDB Lists to Plex Collections Script by /u/blueskillz
#                      *** WORK IN PROGRESS ***
#
#              Created by modifiying the excellent
#
#     Automated IMDB List to Plex Collection Script by /u/deva5610 (v1.0 no multi branch)
#
#              Created by modifiying the excellent
#
...
### Header ###
print("===================================================================")
print(" Automated Multi IMDB Lists&Searches to Multi Collections script by /u/blueskillz  ")
...
# open CSV file in same folder 
with open('list2collection.csv') as csvfile:
     ...
     for row in reader:
        ...
        #IMDB List Details
            IMDB_COLLECTION_NAME = row['Collection']  #insert Collection column header from csv 
        #    print("\n")
           
        #IMDB URL input
            IMDB_URL = row['Link']  #insert IMDB link column header from csv 
        #    print("\n")
        #    if not (IMDB_URL[-1] == slash):
        #        IMDB_URL = IMDB_URL + '/'
            print("Starting job # %d"%(int(reader.line_num) - 1)) 
            print("Update collection: '{}'".format(IMDB_COLLECTION_NAME))
            print("With IMDB List/Search: '{}'".format(IMDB_URL))
            print("\n")
        ...
        # Get list of missing movies from selected list
            ...
            if __name__ == "__main__":
                ...
                #print("\n")
                #EOS = print("y")  #input("Input Y to continue, or N to exit - ")
                #if EOS == "Y" or EOS == "y":
                #print("\n")
                #script()
                #else:
